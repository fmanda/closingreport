	...
	export default {
		data () {
			return {
				...
				columns : [
					...
					{dataKey : 'nama', title : 'Nama Bahan', width: 120},
					{dataKey : 'merk', title : 'Merk', width: 120},
					{dataKey : 'jenis', title : 'Jenis', width: 140},
					{dataKey : 'total', title : 'Total', width: 120}				
				],
				error : {
					status : false,
					title : 'Error Occured',
		...
		methods:{
			refreshData(){
				...
				var url = this.$rest_url + '/reportmaterial/'
						+ date1 + '/' + date2 ;
				var vm = this;
			...
			printData(){
				var header = 'Report Material Periode ' + this.formatedStartDate + ' s/d ' + this.formatedEndDate;
